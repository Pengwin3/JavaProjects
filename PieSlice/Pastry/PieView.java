...
public class PieView extends javax.swing.JPanel {
	...
	public void paint(Graphics g)
	{
		super.paint(g);
		Dimension d = getSize();
		pie.setRadius(Math.min(d.width, d.height)/2);
		int x = 0;
		int y = 0;
		if (d.width > d.height)
		...
		pie.setCenter(new Point(x+ pie.getRadius(),y+ pie.getRadius()));
