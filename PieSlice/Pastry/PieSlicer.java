...
/**
 * Main program: opens a window contianing a Pastry.PieView and two buttons
...
public class PieSlicer extends JFrame implements ActionListener {
	...
	/**
	 * Open a window with the Pastry.PieView and color
	 * selection buttons.
	 */
	public PieSlicer() {
		...
		base.setForeground(pv.getPie().getBaseColor());
		slice.setForeground(pv.getPie().getSliceColor());
		controls.add(base);
		controls.add(slice);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (button == base)
			pv.getPie().setBaseColor(chosen);
		else
			pv.getPie().setSliceColor(chosen);
		pv.repaint();
